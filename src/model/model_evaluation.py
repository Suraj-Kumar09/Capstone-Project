...
# Model evaluation ke liye function create kiya hai, jisme model, x_test aur y_test pass karna hoga aur wo model ko evaluate karke metrics return karega. Is function me error handling bhi honi chahiye taki agar model evaluation me error hota hai to wo log kare aur exception raise kare.
...
# Model evaluation ke bad metrics ke format me save karne ke liye.
