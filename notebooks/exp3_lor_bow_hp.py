...
MLFLOW_TRACKING_URI = "https://dagshub.com/Suraj-Kumar09/Capstone-Project.mlflow"
...
if __name__ == "__main__":
    (X_train, X_test, y_train, y_test), vectorizer = load_and_prepare_data("C:\\Lerarning-\\Capstone-Project\\notebooks\\data.csv")
