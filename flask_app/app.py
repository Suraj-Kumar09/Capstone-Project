...
import os
import pandas as pd
import numpy as np  # <-- Yeh line add ki taaki np.nan perfectly kaam kare
...
# UI transition errors ko bypass karne ke liye direct 'latest' version load kar rahe hain
